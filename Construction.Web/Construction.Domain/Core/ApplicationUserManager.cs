...
namespace Construction.Domain.Core
{
    ...
    {
        public ApplicationUserStore(ApplicationUserDbContext context) : base(context) { }
    }
    public class ApplicationUserManager : UserManager<User, string>
    {
        ...
        {
            var manager = new ApplicationUserManager(new ApplicationUserStore(context.Get<ApplicationUserDbContext>()));
