...
PROJECT.prototype.regisEvent = function () {
    var $this = this;

}

PROJECT.prototype.getList = function () {
    var $this = this;
    ...
    $.each(column, function (index, objColumn) {
        if (objColumn.data == "Action") {
            objColumn.render = function (data, type, row, meta) {
                var $btnEdit = '<a class="btn btn-info" href="/admin/du-an/sua/' + row.Id + '">'
